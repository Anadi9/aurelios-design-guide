      ...
      <div className="card">
        <div className="wrap">
          <div className="terminal">
            ...
            <div className="body">
              <div className="mvp-sequence">
                <div className="command-line">
                  <span className="prompt">$</span> <span className="command">npm run mvp</span>
                </div>
                <div className="output-line" style={{ animationDelay: '1s' }}>
                  <span className="checkmark">✓</span> Building MVP...
                </div>
                <div className="output-line" style={{ animationDelay: '2s' }}>
                  <span className="checkmark">✓</span> Validating features...
                </div>
                <div className="output-line" style={{ animationDelay: '3s' }}>
                  <span className="checkmark">✓</span> Deploying to Production...
                </div>
                <div className="output-line success" style={{ animationDelay: '4s' }}>
                  <span className="checkmark">✓</span> MVP launched in 2 weeks!
                </div>
              </div>
            </div>
          </div>
